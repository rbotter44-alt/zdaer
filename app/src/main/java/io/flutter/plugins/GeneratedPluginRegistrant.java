...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new in.qoder.refresh_rate.RefreshRatePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin refresh_rate, in.qoder.refresh_rate.RefreshRatePlugin", e);
    }
    try {
